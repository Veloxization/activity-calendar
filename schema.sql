...
CREATE TABLE messages (id SERIAL PRIMARY KEY, thread_id INTEGER REFERENCES message_threads, message_read BOOLEAN, sender_id INTEGER REFERENCES users, recipient_id INTEGER REFERENCES users, message VARCHAR(5000));